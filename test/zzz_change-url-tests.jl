...
if !isempty(endpoint)
    ...
    @test mPulseAPI.AnnotationsEndpoint == "$(endpoint)/mpulse/api/annotations/v1"
else
    ...
    @test mPulseAPI.AnnotationsEndpoint == "$(mPulseAPI.default_mPulseEndpoint)/mpulse/api/annotations/v1"
end
...
@test mPulseAPI.AnnotationsEndpoint == "$(new_endpoint)/mpulse/api/annotations/v1"
